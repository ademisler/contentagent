    ...
    return (
        <div className="aicoagac-fade-in">
            ...
            <div className="aicoagac-card">
                <div className="aicoagac-card-header">
                    <h2 className="aicoagac-card-title">
                        <RefreshCw className="aicoagac-nav-item-icon" />
                        Content Analysis
                    </h2>
                </div>
                <p className="aicoagac-page-description">
                ...
                <div className="aicoagac-stat-item">
                    <div className="aicoagac-stat-info">
                        <div className="aicoagac-stat-icon">
                            <CheckCircle />
                        </div>
                        <div>
                            <h4 className="aicoagac-stat-title">Analysis Status</h4>
                            <p className="aicoagac-stat-count">
                    ...
                    >
                        {isLoading && <span className="aicoagac-spinner"></span>}
            ...
            <div className="aicoagac-card">
                <div className="aicoagac-card-header">
                    <h2 className="aicoagac-card-title">
                        <BookOpen className="aicoagac-nav-item-icon" />
                        Your Style Guide
                    </h2>
                </div>
                <p className="aicoagac-page-description">
                ...
                {editableGuide ? (
                    <div className="aicoagac-grid" style={{ gap: '30px' }}>
                        {/* Tone Selection */}
                        <div className="aicoagac-form-group">
                            <label className="aicoagac-label">
                                Writing Tone & Voice
                            </label>
                            <div className="aicoagac-grid aicoagac-grid-3" style={{ padding: '20px', background: '#f6f7f7', borderRadius: '4px', border: '1px solid #ccd0d4' }}>
                        ...
                        <div className="aicoagac-form-group">
                            ...
                            <div style={{ 
                                ...
                                />
                                <div className="aicoagac-grid aicoagac-grid-3" style={{ fontSize: '11px', color: '#646970', marginTop: '12px', fontWeight: '500', textAlign: 'center' as const }}>
                                    <span>Short & Simple</span>
                                    <span>Balanced Mix</span>
                                    <span>Long & Complex</span>
                                </div>
                                <div className="aicoagac-alert info" style={{ marginTop: '15px', textAlign: 'center' as const, fontWeight: '500' }}>
                        ...
                        <div className="aicoagac-form-group">
                            <label className="aicoagac-label">Target Word Count (Pro)</label>
                            {isProActive ? (
                                <div style={{ 
                                    padding: '16px',
                                    background: '#f6f7f7',
                                    ...
                                    />
                                    <span className="aicoagac-page-description" style={{ margin: 0 }}>
                        ...
                        {/* Form Fields Grid */}
                        <div className="aicoagac-grid aicoagac-grid-2">
                            <div className="aicoagac-form-group">
                                <label className="aicoagac-label">Paragraph Length Style</label>
                                <input 
                                    type="text" 
                            ...
                            <div className="aicoagac-form-group">
                                <label className="aicoagac-label">Formatting Preferences</label>
                                <input 
                                    type="text" 
                    ...
                    <div className="aicoagac-card" style={{ 
                        ...
                        <h4 className="aicoagac-card-title">No Style Guide Yet</h4>
                        <p className="aicoagac-page-description">
                ...
                {editableGuide && (
                    <div style={{ 
                        ...
                        {isDirty && (
                            <div className="aicoagac-alert warning" style={{ 
                                display: 'flex',
                                alignItems: 'center',
                                fontSize: '13px', 
                                fontWeight: '500',
                        ...
                        >
                            {isSaving && <span className="aicoagac-spinner"></span>}
