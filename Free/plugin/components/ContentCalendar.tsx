    ...
    return (
        <div className="aicoagac-fade-in">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    ...
                    <div className="aicoagac-card-header">
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <h2 className="aicoagac-card-title">
                                <CalendarIcon className="aicoagac-nav-item-icon" />
                                {currentDate.toLocaleDateString('en-US', { month: 'long', year: 'numeric' })}
                            </h2>
                            <div style={{ display: 'flex', gap: '8px' }}>
                                <button onClick={prevMonth} className="aicoagac-action-button">
                                    <ChevronLeft style={{ width: '20px', height: '20px' }} />
                                </button>
                                <button onClick={nextMonth} className="aicoagac-action-button">
                ...
                <div className="aicoagac-card">
                    <div className="aicoagac-card-header">
                        <h3 className="aicoagac-card-title">Unscheduled Drafts</h3>
                ...
                <div className="aicoagac-card">
                    <div className="aicoagac-card-header">
                        <h3 className="aicoagac-card-title">How to Use</h3>
                    </div>
                    <div className="aicoagac-card-content">
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '20px' }}>
                            <div>
                                <h4 className="aicoagac-label">📅 Scheduling Drafts</h4>
                                <p style={{ margin: 0, fontSize: '14px', color: '#666' }}>
                            ...
                            <div>
                                <h4 className="aicoagac-label">🔄 Rescheduling</h4>
                                <p style={{ margin: 0, fontSize: '14px', color: '#666' }}>
                            ...
                            <div>
                                <h4 className="aicoagac-label">✏️ Editing Content</h4>
                                <p style={{ margin: 0, fontSize: '14px', color: '#666' }}>
                            ...
                            <div>
                                <h4 className="aicoagac-label">📊 Smart Display</h4>
                                <p style={{ margin: 0, fontSize: '14px', color: '#666' }}>
