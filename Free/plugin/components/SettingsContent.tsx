...
export const SettingsContent: React.FC<SettingsContentProps> = ({ 
    ...
    return (
        ...
        >
            ...
            <div className="aicoagac-card" style={{ margin: '0 0 24px 0' }}>
                <div className="aicoagac-card-header">
                    <h3 className="aicoagac-card-title" style={{ display: 'flex', alignItems: 'center', gap: '12px', margin: '0 0 16px 0' }}>
                        <div style={{
                            width: '40px',
                            height: '40px',
                ...
                <div className="aicoagac-form-group">
                    <label className="aicoagac-label" htmlFor="analyze-frequency">{__('Analysis Frequency')}</label>
                    <select 
                    ...
                    <p className="aicoagac-page-description" style={{ marginTop: '5px', margin: '5px 0 0 0' }}>{__('How often should the AI automatically analyze your site content to update the style guide? Manual mode gives you full control.')}</p>
                </div>

                <div className="aicoagac-form-group" style={{ marginTop: '12px' }}>
                    <label className="aicoagac-label" htmlFor="analysis-sampling">{__('Sampling Strategy')}</label>
                    <select
                    ...
                    <div className="aicoagac-help-text">{__('Choose how posts are sampled for style analysis.')}</div>
                </div>

                <div className="aicoagac-form-group" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px', marginTop: '12px' }}>
                    <div>
                        <label className="aicoagac-label" htmlFor="internal-link-topk">{__('Internal Link Top‑K')}</label>
                        <input
                            ...
                            style={{ marginTop: '5px' }}
                        />
                        <div className="aicoagac-help-text">{__('How many internal link candidates to pass into the AI (1‑10).')}</div>
                    </div>
                    <div>
                        <label className="aicoagac-label" htmlFor="max-titles-prompt">{__('Max Titles For Prompt')}</label>
                        <input
                            ...
                            style={{ marginTop: '5px' }}
                        />
                        <div className="aicoagac-help-text">{__('Upper bound for titles included to prevent prompt bloat on large sites.')}</div>
                    </div>
                </div>
                ...
                <div className="aicoagac-form-group" style={{ marginTop: '12px' }}>
                    <label htmlFor="use-fulltext" style={{ display: 'flex', alignItems: 'flex-start', cursor: 'pointer', gap: '12px' }}>
                        ...
                        <span>
                            ...
                            <div className="aicoagac-help-text">{__('If your DB supports FULLTEXT, use it for faster and more relevant internal link candidates.')}</div>
                        </span>
                    </label>
                </div>

                <div className="aicoagac-form-group" style={{ marginTop: '16px' }}>
                    <label className="aicoagac-label">{__('Rebuild Internal Link Index')}</label>
                    <button onClick={handleRebuildIndex} disabled={backfillRunning} className="aicoagac-button secondary">
            ...
            <div className="aicoagac-card" style={{ margin: '0 0 24px 0' }}>
                <div className="aicoagac-card-header">
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                        <h3 className="aicoagac-card-title" style={{ display: 'flex', alignItems: 'center', gap: '12px', margin: 0 }}>
                            <div style={{
                                width: '40px',
                                height: '40px',
                                background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
                        ...
                        {detectedSeoPlugins.length > 0 && (
                            <div className="aicoagac-alert success" style={{ 
                                display: 'flex', 
                                alignItems: 'center', 
                                fontSize: '12px', 
                                fontWeight: '600',
                ...
                {seoPluginsLoading ? (
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '20px 0' }}>
                        <span className="aicoagac-spinner"></span>
                    ...
                    <div>
                        ...
                        >
                            {isDetectingSeo && <span className="aicoagac-spinner"></span>}
            ...
            <div className="aicoagac-card" style={{ margin: '0 0 24px 0' }}>
                ...
                <div className="aicoagac-card-body">
                    <div className="aicoagac-form-group">
                        <label htmlFor="faq-enabled" style={{ display: 'flex', alignItems: 'flex-start', cursor: 'pointer', gap: '12px' }}>
                            ...
                            <span>
                                ...
                                <div className="aicoagac-help-text">Adds FAQ structured data for better SERP compatibility.</div>
                            </span>
                        </label>
                    </div>
                    {currentSettings.faqEnabled && (
                        <>
                            <div className="aicoagac-form-group" style={{ marginTop: '10px' }}>
                                <label className="aicoagac-label" htmlFor="faq-count">FAQ Count</label>
                                <select
                                    id="faq-count"
                                    className="aicoagac-input"
                            ...
                            <div className="aicoagac-form-group" style={{ marginTop: '10px' }}>
                                <label htmlFor="faq-display-in-content" style={{ display: 'flex', alignItems: 'flex-start', cursor: 'pointer', gap: '12px' }}>
                                    ...
                                    <span>
                                        ...
                                        <div className="aicoagac-help-text">Displays a styled Q&A section in content while still adding schema.</div>
                                    </span>
                                </label>
                            </div>
                        </>
