    ...
    return (
        <div className="aicoagac-card" style={{ 
            ...
            <div style={{ marginBottom: '15px' }}>
                <h3 className="aicoagac-card-title" style={{ marginBottom: '8px' }}>
                    {draft.title}
                </h3>
                <div className="aicoagac-page-description" style={{ display: 'flex', alignItems: 'center', gap: '15px', flexWrap: 'wrap' }}>
            ...
            {/* Actions */}
            <div className="aicoagac-list-item" style={{ padding: '15px 0 0 0', margin: 0, justifyContent: 'flex-end', gap: '12px' }}>
                <button
                    onClick={() => {
                ...
                >
                    <Eye className="aicoagac-nav-item-icon" style={{ color: '#0073aa', strokeWidth: '1.5' }} />
                    View Draft
                </button>
            ...
            {drafts.length > 0 ? (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
                        ...
                        <div className="aicoagac-card">
                            <div className="aicoagac-card-header">
                                <h2 className="aicoagac-card-title">
                                    <Calendar className="aicoagac-nav-item-icon" />
                    ...
                    {unscheduledDrafts.length > 0 && (
                        <div className="aicoagac-card">
                            <div className="aicoagac-card-header">
                                <h2 className="aicoagac-card-title">
                                    <FileText className="aicoagac-nav-item-icon" />
                ...
                <div className="aicoagac-card">
                    <div style={{ textAlign: 'center', padding: '60px 20px', color: '#646970' }}>
                        ...
                        <h3 className="aicoagac-card-title">No Drafts Created Yet</h3>
