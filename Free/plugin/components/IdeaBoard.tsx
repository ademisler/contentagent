...
const IdeaCard: React.FC<{
    ...
    return (
        <div className={`aicoagac-card ${isLoading ? 'loading' : ''}`} style={{ margin: 0, minHeight: '140px' }}>
            {/* Idea Title */}
            ...
            <div className="aicoagac-list-item" style={{ padding: '15px 0 0 0', margin: 0 }}>
                {/* Source Tag */}
                <div style={{ 
                    fontSize: '11px', 
                    fontWeight: '600', 
    ...
    return (
        <div className="aicoagac-fade-in">
            ...
            <div className="aicoagac-card">
                <div className="aicoagac-card-header">
                    <h2 className="aicoagac-card-title">
                        <PlusCircle className="aicoagac-nav-item-icon" />
                        Add Your Own Idea
                    </h2>
                </div>
                <form onSubmit={handleAddIdeaSubmit} style={{ display: 'flex', gap: '12px', alignItems: 'flex-end' }}>
                    <div className="aicoagac-form-group" style={{ flexGrow: 1, marginBottom: 0 }}>
                        <label className="aicoagac-label" htmlFor="new-idea-input">Idea Title</label>
                        <input
                            id="new-idea-input"
                            type="text"
                            value={newIdeaTitle}
            ...
            {activeIdeas.length > 0 ? (
                <div className="aicoagac-card">
                    <div className="aicoagac-card-header" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '12px' }}>
                        <h2 className="aicoagac-card-title" style={{ display: 'flex', alignItems: 'center', gap: '8px', margin: 0 }}>
                            <Lightbulb className="aicoagac-nav-item-icon" />
                ...
                <div className="aicoagac-card">
                    <div style={{ textAlign: 'center', padding: '60px 20px', color: '#646970' }}>
                        ...
                        <h3 className="aicoagac-card-title">No Active Ideas Yet</h3>
                        <p className="aicoagac-page-description" style={{ maxWidth: '400px', marginLeft: 'auto', marginRight: 'auto' }}>
            ...
            {archivedIdeas.length > 0 && (
                <div className="aicoagac-card">
                    <div className="aicoagac-card-header" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '12px' }}>
                        <div>
                            <h2 className="aicoagac-card-title" style={{ margin: 0 }}>
                                Archived Ideas ({archivedIdeas.length})
                            </h2>
                            <p className="aicoagac-page-description" style={{ margin: 0, fontSize: '14px' }}>
                    ...
                    <div className="aicoagac-list">
                        {archivedIdeas.map((idea) => (
                            <div key={idea.id} className="aicoagac-list-item">
                                <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexGrow: 1 }}>
                                    <input
                                        type="checkbox"
