...
body.toplevel_page_ai-content-agent #wpfooter {
  ...
  const makeApiCall = async (path, options = {}) => {
    ...
    console.log("ACA: Making API call to:", path);
    console.log("ACA: Nonce:", window.aicoagacData.nonce ? window.aicoagacData.nonce.substring(0, 10) + "..." : "NOT SET");
    const response = await fetch(`${window.aicoagacData.api_url}${path}`, mergedOptions);
    if (!response.ok) {
      let errorMessage = `HTTP error! status: ${response.status}`;
      console.error("ACA: API call failed:", {
        path,
      ...
      try {
        ...
        if (contentType && contentType.includes("application/json")) {
          ...
          console.error("ACA: Error data:", errorData);
          errorMessage = errorData.message || errorData.code || JSON.stringify(errorData);
          if (errorData.code === "rest_cookie_invalid_nonce" || errorData.code === "invalid_nonce" || errorData.code === "rest_forbidden") {
            errorMessage = "Session expired. Please refresh the page and try again.";
            console.error("ACA: Nonce error detected. User should refresh the page.");
          }
        } else {
  ...
  const GeminiApiWarning = ({ onNavigateToSettings }) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "aicoagac-gemini-warning",
        style: {
  ...
  const Sidebar = ({ currentView, setView, isOpen, closeSidebar }) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: `aicoagac-sidebar ${isOpen ? "open" : ""}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-sidebar-header", style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "aicoagac-sidebar-nav", style: { padding: "0 16px" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative", zIndex: 1 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { style: { width: "18px", height: "18px", color: "#fbbf24" } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: {
              color: "white",
              fontSize: "14px",
              fontWeight: "700",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: {
            ...
            lineHeight: "1.5",
            margin: "0 0 12px 0"
          }, children: "Unlock powerful features:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { style: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { style: { display: "flex", alignItems: "center", gap: "6px" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#fbbf24" }, children: "✓" }),
              " Full Automation System"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { style: { display: "flex", alignItems: "center", gap: "6px" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#fbbf24" }, children: "✓" }),
              " Longer Content (5000+ words)"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { style: { display: "flex", alignItems: "center", gap: "6px" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#fbbf24" }, children: "✓" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
            ...
            color: "rgba(255,255,255,0.9)",
            textAlign: "center"
          }, children: "🎁 Special Launch Price - Limited Time" })
        ] })
      ] })
    ] });
  };
  ...
  const ActivityLogItem = ({ log }) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-list-item", style: { padding: "12px 0", borderBottom: "1px solid #f0f0f1" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "flex-start", gap: "12px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
        width: "32px",
        height: "32px",
      ...
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: "8px", flex: 1, minWidth: 0 }, children: [
            ...
            isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "aicoagac-spinner", style: { width: "14px", height: "14px", marginLeft: "auto" } })
          ] })
        ]
      }
    );
  });
  const PipelineItem = reactExports.memo(({ icon, title, count, description, view, onNavigate }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-stat-item", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-stat-info", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-stat-icon", children: icon }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "aicoagac-stat-title", children: title }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "aicoagac-stat-count", children: [
          count,
          " ",
          description
        ] })
  ...
  const Dashboard = ({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-welcome-section", style: {
        background: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)",
        borderRadius: "12px",
        padding: "30px",
        marginBottom: "30px",
      ...
      !isStyleGuideReady && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-alert info", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "15px" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-grid aicoagac-grid-2", style: { marginBottom: "30px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card", style: {
          background: "linear-gradient(145deg, #f8fafc 0%, #f1f5f9 100%)",
          border: "1px solid #e2e8f0",
          boxShadow: "0 4px 6px -1px rgba(0, 0, 0, 0.1)"
        }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card-header", style: { borderBottom: "1px solid #e2e8f0", paddingBottom: "15px" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "aicoagac-card-title", style: {
              display: "flex",
              alignItems: "center",
              gap: "8px",
              color: "#1e293b"
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-grid aicoagac-grid-2", style: { marginTop: "20px" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ActionButton,
              {
                icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Lightbulb, {}),
      ...
      isStyleGuideReady && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-card-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "aicoagac-card-title", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-card-header", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "aicoagac-card-title", children: "Recent Activity" }) }),
  ...
  const UpgradePrompt = ({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-upgrade-prompt", style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1 }, children: [
        ...
        features.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { style: {
          margin: "0",
          paddingLeft: "20px",
          fontSize: "13px",
          color: "#6c757d"
        }, children: features.map((feature, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { style: { marginBottom: "4px" }, children: feature }, index)) })
      ] })
    ] }) });
  };
  ...
  const StyleGuideManager = ({ styleGuide, onAnalyze, onSaveStyleGuide, isLoading }) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-fade-in", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-card-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "aicoagac-card-title", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "aicoagac-nav-item-icon" }),
          "Content Analysis"
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aicoagac-page-description", children: "The AI periodically scans your published content to understand your writing style and automatically updates your guide." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-stat-item", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-stat-info", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-stat-icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "aicoagac-stat-title", children: "Analysis Status" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aicoagac-stat-count", children: styleGuide?.lastAnalyzed ? `Last updated: ${new Date(styleGuide.lastAnalyzed).toLocaleDateString()} at ${new Date(styleGuide.lastAnalyzed).toLocaleTimeString()}` : "Never analyzed" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              className: "aicoagac-button large",
              children: [
                isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "aicoagac-spinner" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-card-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "aicoagac-card-title", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "aicoagac-nav-item-icon" }),
          "Your Style Guide"
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aicoagac-page-description", children: "Review and customize the AI-generated style guide below. These settings will influence all future content generation." }),
        editableGuide ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-grid", style: { gap: "30px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-form-group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "aicoagac-label", children: "Writing Tone & Voice" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-grid aicoagac-grid-3", style: { padding: "20px", background: "#f6f7f7", borderRadius: "4px", border: "1px solid #ccd0d4" }, children: PREDEFINED_TONES.map((tone) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: () => handleToneToggle(tone),
                className: `aicoagac-button ${selectedTones.has(tone) ? "" : "secondary"}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-form-group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "aicoagac-label", children: "Sentence Structure Preference" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
              padding: "20px",
              background: "#f6f7f7",
              borderRadius: "4px",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-grid aicoagac-grid-3", style: { fontSize: "11px", color: "#646970", marginTop: "12px", fontWeight: "500", textAlign: "center" }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-alert info", style: { marginTop: "15px", textAlign: "center", fontWeight: "500" }, children: sentenceStructureMap[sentenceSliderValue] })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-form-group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "aicoagac-label", children: "Target Word Count (Pro)" }),
            isProActive ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "aicoagac-page-description", style: { margin: 0 }, children: "Recommend 800–1500 for best UX/SEO. Pro users can increase for long-form." })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
              UpgradePrompt,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-grid aicoagac-grid-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-form-group", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "aicoagac-label", children: "Paragraph Length Style" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "text",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-form-group", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "aicoagac-label", children: "Formatting Preferences" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  type: "text",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "aicoagac-card-title", children: "No Style Guide Yet" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aicoagac-page-description", children: "Run your first content analysis to generate your personalized style guide." })
        ] }),
        editableGuide && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
          ...
          isDirty && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-alert warning", style: {
            display: "flex",
            alignItems: "center",
            fontSize: "13px",
            fontWeight: "500",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                isSaving && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "aicoagac-spinner" }),
  ...
  const IdeaCard = ({ idea, onCreateDraft, onArchive, onUpdateTitle, onGenerateSimilar, isLoading, isGeneratingSimilar, selectable = false, selected = false, onToggleSelect, isDraftCreationLocked, isQueued, queuePosition, onDequeueQueuedIdea }) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `aicoagac-card ${isLoading ? "loading" : ""}`, style: { margin: 0, minHeight: "140px" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-list-item", style: { padding: "15px 0 0 0", margin: 0 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
          fontSize: "11px",
          fontWeight: "600",
          padding: "6px 12px",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: "8px", flexShrink: 0 }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                isGeneratingSimilar ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "aicoagac-spinner", style: { width: "14px", height: "14px" } }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { style: { width: "14px", height: "14px" } }),
                "Similar"
              ]
            }
          ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              className: `aicoagac-button ${!isLoading && !isQueued && isDraftCreationLocked ? "queue-add" : ""}`,
              style: {
                fontSize: "12px",
                padding: "6px 16px",
                minWidth: "120px",
              ...
              children: [
                isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: "6px" }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "aicoagac-spinner", style: { width: "14px", height: "14px" } }),
                ...
                isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
                  ...
                  height: "100%",
                  background: "#00a32a",
                  animation: "aicoagac-progress-slide 2s infinite linear"
                } }) })
              ]
            }
          ),
  ...
  const IdeaBoard = ({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-fade-in", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-card-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "aicoagac-card-title", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CirclePlus, { className: "aicoagac-nav-item-icon" }),
          "Add Your Own Idea"
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleAddIdeaSubmit, style: { display: "flex", gap: "12px", alignItems: "flex-end" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-form-group", style: { flexGrow: 1, marginBottom: 0 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "aicoagac-label", htmlFor: "new-idea-input", children: "Idea Title" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                id: "new-idea-input",
      ...
      activeIdeas.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card-header", style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: "12px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "aicoagac-card-title", style: { display: "flex", alignItems: "center", gap: "8px", margin: 0 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Lightbulb, { className: "aicoagac-nav-item-icon" }),
            "Active Ideas (",
            activeIdeas.length,
            ")"
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-grid aicoagac-grid-2", children: activeIdeas.map((idea) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          IdeaCard,
          {
            idea,
            onCreateDraft,
      ...
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", padding: "60px 20px", color: "#646970" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Lightbulb, { style: { margin: "0 auto 20px auto", width: "48px", height: "48px", fill: "#a7aaad" } }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "aicoagac-card-title", children: "No Active Ideas Yet" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aicoagac-page-description", style: { maxWidth: "400px", marginLeft: "auto", marginRight: "auto" }, children: "Get started by generating AI-powered content ideas or adding your own manually." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: "10px", justifyContent: "center", flexWrap: "wrap" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            className: "aicoagac-button large",
            children: [
              isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "aicoagac-spinner" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Lightbulb, { style: { width: "16px", height: "16px" } }),
              isLoading ? "Generating..." : "Generate Ideas"
            ]
          }
        ) })
      ] }) }),
      archivedIdeas.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card-header", style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: "12px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "aicoagac-card-title", style: { margin: 0 }, children: [
              "Archived Ideas (",
              archivedIdeas.length,
              ")"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aicoagac-page-description", style: { margin: 0, fontSize: "14px" }, children: "Manage your archived ideas - restore them or delete permanently" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: "12px" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { style: { display: "flex", alignItems: "center", gap: "8px", fontSize: "12px", color: "#475569" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-list", children: archivedIdeas.map((idea) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-list-item", children: [
  ...
  const DraftCard = ({ draft, onSelectDraft, onPublish, isPublishing }) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card", style: {
      margin: 0,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "15px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "aicoagac-card-title", style: { marginBottom: "8px" }, children: draft.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-page-description", style: { display: "flex", alignItems: "center", gap: "15px", flexWrap: "wrap" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-list-item", style: { padding: "15px 0 0 0", margin: 0, justifyContent: "flex-end", gap: "12px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            onClick: () => {
              ...
              const editUrl = `${window.aicoagacData.admin_url}post.php?post=${draft.id}&action=edit`;
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { className: "aicoagac-nav-item-icon", style: { color: "#0073aa", strokeWidth: "1.5" } }),
              "View Draft"
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: isPublishing ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "aicoagac-spinner" }),
              "Publishing..."
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { className: "aicoagac-nav-item-icon" }),
              "Publish Now"
            ] })
          }
        )
  ...
  const DraftsList = ({ drafts, onSelectDraft, onPublish, publishingId, onNavigateToIdeas }) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-fade-in", children: [
      ...
      drafts.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "30px" }, children: [
        scheduledDrafts.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-card-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "aicoagac-card-title", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "aicoagac-nav-item-icon" }),
            "Scheduled Drafts (",
            scheduledDrafts.length,
            ")"
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-grid aicoagac-grid-2", children: scheduledDrafts.map((draft) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            DraftCard,
            {
              draft,
              onSelectDraft,
        ...
        unscheduledDrafts.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-card-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "aicoagac-card-title", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "aicoagac-nav-item-icon" }),
            "Ready to Publish (",
            unscheduledDrafts.length,
            ")"
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-grid aicoagac-grid-2", children: unscheduledDrafts.map((draft) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            DraftCard,
            {
              draft,
              onSelectDraft,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "aicoagac-card-title", children: "No Drafts Created Yet" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aicoagac-page-description", style: { maxWidth: "400px", marginLeft: "auto", marginRight: "auto" }, children: "Create content ideas first, then turn them into drafts to see them here." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
  ...
  const SettingsLayout = ({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-page", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-page-header", style: {
        background: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)",
        color: "white",
        padding: "32px",
        borderRadius: "12px",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-settings-content", children }),
      actions && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-settings-actions", style: {
        marginTop: "32px",
        padding: "24px",
        background: "#f8fafc",
        borderRadius: "12px",
  ...
  const IntegrationCard = ({ title, icon, children, isConfigured }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card", style: { margin: "0 0 24px 0" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-card-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "aicoagac-card-title", style: { display: "flex", alignItems: "center", gap: "12px", margin: 0 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
          width: "40px",
          height: "40px",
          background: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)",
      ...
      isConfigured && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-alert success", style: {
        display: "flex",
        alignItems: "center",
        fontSize: "12px",
        fontWeight: "600",
  ...
  const SettingsIntegrations = ({
    ...
    const saveButton = isDirty ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: handleSave,
        disabled: isSaving,
        className: "aicoagac-button aicoagac-button-primary",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            IntegrationCard,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-form-group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "gemini-api-key", className: "aicoagac-label", children: "API Key" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    ...
                    target: "_blank",
                    rel: "noopener noreferrer",
                    className: "aicoagac-page-description",
                    style: {
                      color: "#0073aa",
                      textDecoration: "none",
                      marginTop: "8px",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            IntegrationCard,
            {
              ...
              isConfigured: false,
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-form-group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aicoagac-page-description", style: { marginBottom: "12px" }, children: "Native ChatGPT support is on the way. You will be able to generate ideas and drafts with OpenAI models (e.g., GPT-4o). This section is a preview." }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            IntegrationCard,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aicoagac-page-description", style: { marginBottom: "20px" }, children: "Select where to get featured images. For stock photo sites, an API key is required." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
                  display: "grid",
                  ...
                  "label",
                  {
                    className: `aicoagac-button ${currentSettings.imageSourceProvider === provider ? "" : "secondary"}`,
                    style: {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-form-group", style: { marginTop: "8px", marginBottom: "20px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: "12px" }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "aicoagac-label", children: "Enforce 16:9 aspect ratio" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aicoagac-page-description", style: { marginTop: "5px", margin: "5px 0 0 0" }, children: "Crops images to 16:9 without resizing (no quality loss). Ensures consistent featured image framing." })
                  ] })
                ] }) }),
                currentSettings.imageSourceProvider === "ai" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-fade-in", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-form-group", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "ai-image-style", className: "aicoagac-label", children: "AI Image Style" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "select",
                      {
                        id: "ai-image-style",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-form-group", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "google-cloud-project-id", className: "aicoagac-label", children: "Google Cloud Project ID" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "input",
                      {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aicoagac-page-description", style: { marginTop: "8px", fontSize: "13px" }, children: "Required for AI image generation using Google's Imagen API" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-form-group", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "google-cloud-location", className: "aicoagac-label", children: "Google Cloud Location" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "select",
                      {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aicoagac-page-description", style: { marginTop: "8px", fontSize: "13px" }, children: "Choose the Google Cloud region closest to your users" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "a",
                    {
                ...
                currentSettings.imageSourceProvider === "pexels" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-form-group aicoagac-fade-in", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "pexels-api-key", className: "aicoagac-label", children: "Pexels API Key" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      id: "pexels-api-key",
                ...
                currentSettings.imageSourceProvider === "unsplash" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-form-group aicoagac-fade-in", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "unsplash-api-key", className: "aicoagac-label", children: "Unsplash Access Key" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      id: "unsplash-api-key",
                ...
                currentSettings.imageSourceProvider === "pixabay" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-form-group aicoagac-fade-in", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "pixabay-api-key", className: "aicoagac-label", children: "Pixabay API Key" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      id: "pixabay-api-key",
  ...
  const SettingsContent = ({
    ...
    reactExports.useEffect(() => {
      const loadSeoPlugins = async () => {
        if (!window.aicoagacData) return;
        try {
          const response = await fetch(window.aicoagacData.api_url + "seo-plugins", {
            headers: { "X-WP-Nonce": window.aicoagacData.nonce }
          });
    ...
    const runBackfillBatch = async (reset = false) => {
      ...
      const res = await fetch(`${window.aicoagacData.api_url}index/backfill?${qs}`, {
        method: "POST",
        headers: { "X-WP-Nonce": window.aicoagacData.nonce }
      });
      if (!res.ok) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      SettingsLayout,
      {
        ...
        actions: saveButton,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card", style: { margin: "0 0 24px 0" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-card-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "aicoagac-card-title", style: { display: "flex", alignItems: "center", gap: "12px", margin: "0 0 16px 0" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: {
                width: "40px",
                height: "40px",
                background: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-form-group", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "aicoagac-label", htmlFor: "analyze-frequency", children: __("Analysis Frequency") }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "select",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aicoagac-page-description", style: { marginTop: "5px", margin: "5px 0 0 0" }, children: __("How often should the AI automatically analyze your site content to update the style guide? Manual mode gives you full control.") })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-form-group", style: { marginTop: "12px" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "aicoagac-label", htmlFor: "analysis-sampling", children: __("Sampling Strategy") }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "select",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-help-text", children: __("Choose how posts are sampled for style analysis.") })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-form-group", style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", marginTop: "12px" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "aicoagac-label", htmlFor: "internal-link-topk", children: __("Internal Link Top‑K") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-help-text", children: __("How many internal link candidates to pass into the AI (1‑10).") })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "aicoagac-label", htmlFor: "max-titles-prompt", children: __("Max Titles For Prompt") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-help-text", children: __("Upper bound for titles included to prevent prompt bloat on large sites.") })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-form-group", style: { marginTop: "12px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { htmlFor: "use-fulltext", style: { display: "flex", alignItems: "flex-start", cursor: "pointer", gap: "12px" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
                  id: "use-fulltext",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-help-text", children: __("If your DB supports FULLTEXT, use it for faster and more relevant internal link candidates.") })
              ] })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-form-group", style: { marginTop: "16px" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "aicoagac-label", children: __("Rebuild Internal Link Index") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleRebuildIndex, disabled: backfillRunning, className: "aicoagac-button secondary", children: backfillRunning ? __("Rebuilding...") : __("Rebuild Index") }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card", style: { margin: "0 0 24px 0" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-card-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }, children: [
              ...
              detectedSeoPlugins.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-alert success", style: {
                display: "flex",
                alignItems: "center",
                fontSize: "12px",
                fontWeight: "600",
            ...
            seoPluginsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: "10px", padding: "20px 0" }, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    isDetectingSeo && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "aicoagac-spinner" }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  onClick: handleAutoDetectSeo,
                  disabled: isDetectingSeo,
                  className: "aicoagac-button primary",
                  style: { width: "100%", justifyContent: "center" },
                  children: [
                    isDetectingSeo && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "aicoagac-spinner" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card", style: { margin: "0 0 24px 0" }, children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card-body", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-form-group", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { htmlFor: "faq-enabled", style: { display: "flex", alignItems: "flex-start", cursor: "pointer", gap: "12px" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
                    id: "faq-enabled",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-help-text", children: "Adds FAQ structured data for better SERP compatibility." })
                ] })
              ] }) }),
              currentSettings.faqEnabled && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-form-group", style: { marginTop: "10px" }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "aicoagac-label", htmlFor: "faq-count", children: "FAQ Count" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "select",
                    {
                      id: "faq-count",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-form-group", style: { marginTop: "10px" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { htmlFor: "faq-display-in-content", style: { display: "flex", alignItems: "flex-start", cursor: "pointer", gap: "12px" }, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-help-text", children: "Displays a styled Q&A section in content while still adding schema." })
                  ] })
                ] }) })
              ] })
            ] })
  ...
  const DraftModal = ({ draft, onClose, onSave, settings }) => {
    ...
    const handleSendToSeoPlugin = async () => {
      ...
      try {
        const response = await fetch(`${window.aicoagacData?.api_url || ""}/seo-analysis`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            "X-WP-Nonce": window.aicoagacData?.nonce || ""
  ...
  const Toast = ({ id, message, type, onDismiss }) => {
    ...
    reactExports.useEffect(() => {
      if (!document.querySelector("#aicoagac-toast-styles")) {
        const style = document.createElement("style");
        style.id = "aicoagac-toast-styles";
        style.textContent = `
                @keyframes aicoagac-toast-progress {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                ...
                animation: "aicoagac-toast-progress 5s linear forwards",
  ...
  const PublishedPostCard = ({ post, onSelectPost }) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card", style: { margin: 0, position: "relative" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: "15px", paddingRight: "100px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "aicoagac-card-title", style: {
          color: "#00a32a",
          marginBottom: "8px"
        }, children: post.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-page-description", style: {
          display: "flex",
          alignItems: "center",
          gap: "15px",
          flexWrap: "wrap"
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-list-item", style: { padding: "15px 0 0 0", margin: 0, justifyContent: "flex-end" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "aicoagac-nav-item-icon", style: { color: "#0073aa", strokeWidth: "1.5" } }),
            "View Live Post"
          ]
        }
      ) })
  ...
  const PublishedList = ({ posts, onSelectPost, onNavigateToDrafts, total, page = 1, totalPages = 1, onPageChange }) => {
    ...
    const renderPagination = () => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-pagination", style: { display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "16px", gap: "12px", flexWrap: "wrap" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-page-description", style: { fontSize: "13px", color: "#111827" }, children: [
          __("Page"),
          " ",
          current,
          " ",
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-fade-in", children: [
      ...
      posts.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-card-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "aicoagac-card-title", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { className: "aicoagac-nav-item-icon" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-grid aicoagac-grid-2", children: sortedPosts.map((post) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          PublishedPostCard,
          {
            post,
            onSelectPost
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-card-content", children: renderPagination() })
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center", padding: "60px 20px", color: "#646970" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { style: { margin: "0 auto 20px auto", width: "48px", height: "48px", fill: "#a7aaad" } }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "aicoagac-card-title", children: "No Published Posts Yet" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "aicoagac-page-description", style: { maxWidth: "400px", marginLeft: "auto", marginRight: "auto" }, children: "Create drafts and publish them to see your success stories here." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: "10px", justifyContent: "center", flexWrap: "wrap" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
  ...
  const ContentCalendar = ({ drafts, publishedPosts, onScheduleDraft, onSelectPost, onPublishDraft, onUpdatePostDate }) => {
    ...
    const openWordPressEditor = (postId) => {
      ...
      const editUrl = `${window.aicoagacData.admin_url}post.php?post=${postId}&action=edit`;
      window.open(editUrl, "_blank");
    };
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-fade-in", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "20px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-card-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "center" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "aicoagac-card-title", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "aicoagac-nav-item-icon" }),
              currentDate.toLocaleDateString("en-US", { month: "long", year: "numeric" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: "8px" }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: prevMonth, className: "aicoagac-action-button", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { style: { width: "20px", height: "20px" } }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: nextMonth, className: "aicoagac-action-button", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { style: { width: "20px", height: "20px" } }) })
            ] })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-card-content", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
            display: "grid",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card-header", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "aicoagac-card-title", children: "Unscheduled Drafts" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-card-header", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "aicoagac-card-title", children: "How to Use" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-card-content", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "20px" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "aicoagac-label", children: "📅 Scheduling Drafts" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "aicoagac-label", children: "🔄 Rescheduling" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "aicoagac-label", children: "✏️ Editing Content" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "aicoagac-label", children: "📊 Smart Display" }),
  ...
  const App = () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-container", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-main", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-mobile-header", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aicoagac-fade-in", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aicoagac-toast-container", children: toasts.map((toast) => /* @__PURE__ */ jsxRuntimeExports.jsx(Toast, { ...toast, onDismiss: removeToast }, toast.id)) })
    ] });
  };
